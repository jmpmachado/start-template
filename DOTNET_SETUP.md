...
| **VS2022 already installed** (Community / Pro / Enterprise) | Install **.NET 9 SDK standalone** only — see §2 ✅ |
| CI/CD agent (no GUI) | Install **VS2022 Build Tools + .NET SDK** silently — see §3 |

> **This project**: VS2022 base is present → follow **§2** (standalone .NET 9 SDK).
...
## §2 — VS2022 Already Installed: standalone .NET 9 SDK
...
4. Under **Individual components** → check **.NET 9 Runtime**
...
|---|---|---|---|
| .NET SDK | 9.0.x (STS) | 9.0.x | net9.0 TFM � active |
