#!/usr/bin/env python3
"""
wizard.py — Standalone adoption wizard for the engineering template.
...
def main() -> None:
    print("\n  engineering template -- Adoption Wizard")
    print("  " + "-" * 60)
    ...
    entry = (
        ...
        f"- **Wizard mode:** standalone\n"
        f"- **Rationale:** Template adopted via standalone wizard.\n"
    )
