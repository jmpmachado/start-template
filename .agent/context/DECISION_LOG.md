...
**Date:** 2026-05-23
**Status:** Accepted
**Participants:** @<your-github-handle> (engineer), Claude Code (claude-sonnet-4-6), Codex, Copilot, Antigravit
...
**Date:** 2026-05-23
**Status:** Accepted
**Participants:** @<your-github-handle>, Claude Code
...
### DL-013 — Python standalone wizard selected as canonical adoption path

**Date:** 2026-05-27
**Status:** Accepted
**Participants:** @<your-github-handle>, Claude Code (claude-sonnet-4-6)
**Context:** Multiple adoption-wizard approaches were evaluated before the template settled on a single canonical flow. The retained approach is the standalone Python wizard (`wizard.py`), which keeps the adoption path focused and minimizes required tooling during first-time setup.
**Decision:** Standardize on the standalone Python wizard as the canonical adoption entry point.
**Rationale:** (1) The Python wizard requires only `python3 + pyyaml`, which already aligns with the template tooling surface. (2) A single canonical entry point reduces adoption ambiguity. (3) The wizard test suite provides focused falsification coverage for adoption workflows.
**Consequences:** `wizard.py` is the authoritative adoption path. `profiles.yaml` (founder/team/public) remains the canonical profile taxonomy.
...
### DL-017 — Consolidate adoption on the Python wizard

**Date:** 2026-05-28
**Status:** Accepted
**Participants:** @<your-github-handle>, Claude Code (claude-sonnet-4-6)
**Context:** DL-013 (2026-05-27) selected the Python standalone wizard (`infra/scripts/wizard.py`) as canonical. A secondary Node-based adoption path still existed and created ambiguity during adoption.
**Decision:** Standardize all adoption guidance on `python infra/scripts/wizard.py`.
**Rationale:** Single entry point reduces confusion. The Python wizard has the maintained test coverage and is the authoritative path.
**Consequences:** Adoption guidance, validation hints, and operator docs must point only to `python infra/scripts/wizard.py`.
