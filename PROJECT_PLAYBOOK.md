...
- **Protocol:** [.agent/context/TEMPLATE_UPGRADE_PROTOCOL.md](.agent/context/TEMPLATE_UPGRADE_PROTOCOL.md)
- **Changelog:** [CHANGELOG.md](CHANGELOG.md) — review breaking changes before upgrade
- **Backlog health:** `BACKLOG.md` ≤ 150 lines before upgrade; archive Done sprints to `BACKLOG_HISTORY.md`
